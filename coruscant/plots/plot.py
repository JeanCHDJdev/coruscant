...
def plot_settings(custom_settings: Optional[Dict[str, Any]] = None):
    ...
    custom_settings : dict, optional
        Custom rcParams to override defaults, if needed.
    """
    # reload rcParams defaults
    plt.rcdefaults()

    # apply new default settings (default settings for paper plots)
    default_settings = {
        'font.family': 'serif',
...
class PlotManager:
    ...
    def __init__(
        ...
        overwrite : bool
            Default overwrite behavior for existing files when saving plots.
            If False, raises FileExistsError if a file already exists.
        show : bool
            Default behavior for displaying plots interactively, for example in Jupyter notebooks.
        custom_settings : dict, optional
    ...
    def make_plot(
        ...
        **subplot_kwargs
        ...
        """
        Context manager for creating plots.
        ...
        figsize : tuple, optional
            Figure size (width, height). Default is PlotManager's default_figsize.
        dpi : int, optional
            DPI for the figure. Default is PlotManager's default_dpi.
        formats : str or list
            File format(s) to save ('png', 'pdf', 'svg', etc.). 
            If None, no files will be saved. Default is 'png'.
        tight_layout : bool
            Whether to use tight_layout(). Default is True.
        bbox_inches : str
            bbox_inches parameter for savefig. Default is 'tight'.
        facecolor : str
            Face color for the figure. Default is 'white'.
        nrows, ncols : int
            Number of subplot rows and columns. Default is 1 for both.
        custom_layout : bool
            If True, yields only the figure for custom subplot arrangements. Default is False.
        add_labels : bool
            Whether to add (a), (b), (c), etc. labels to subplots. Default is False.
        label_position : str
            Position of the labels ('upper left', 'upper right', etc.). Default is 'upper left'.
        **subplot_kwargs
        ...
        fig, ax : matplotlib Figure and Axes objects
            ...
            If nrows=ncols=1 (default), ax is a single Axes object
        ...
        # keep file paths empty if formats is None
        file_paths = []
